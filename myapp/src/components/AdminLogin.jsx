...
function AdminLogin() {
    ...
    //const q_email = query(collection(db,"hr_admin"),where("email","==",email))
    //const q_password = query(collection(db,"hr_admin"),where("password","==",password))
    //const q_role = query(collection(db,"hr_admin"),where("role","==","Admin"))
    const q = query(collection(db,"hr_admin"),where("email","==",email),where("password","==",password),where("role","==","Admin"))
